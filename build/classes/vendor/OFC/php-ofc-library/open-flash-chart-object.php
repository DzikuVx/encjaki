...
function _ofc( $width, $height, $url, $use_swfobject, $base )
{
    ...
    $out[] = '<param name="flashvars" value="data-file='.htmlspecialchars($url).'"/>';
    $out[] = '<param name="quality" value="high" />';
    $out[] = '<param name="bgcolor" value="#FFFFFF" />';
    $out[] = '<param name="wmode" value="transparent">';
    $out[] = '<embed src="'. $base .'open-flash-chart.swf?data-file=' . $url .'" quality="high" bgcolor="#FFFFFF" width="'. $width .'" height="'. $height .'" name="'. $obj_id .'" align="middle" allowScriptAccess="always" wmode="transparent" ';
