  ...
  jQuery(wym._options.dialogLinkSelector + " "
    + wym._options.submitSelector).click(function() {
      ...
      if(sUrl.length > 0) {
        ...
        tObj = wym._doc.createElement('a');
        tObj.href = sUrl;
        tObj.title = jQuery(wym._options.titleSelector).val();
        tObj.innerHTML = jQuery(wym._options.titleSelector).val();
        jQuery(wym._doc.body).append(tObj);
        jQuery(wym._doc.body).append(' ');
  ...
  jQuery(wym._options.dialogImageSelector + " "
    + wym._options.submitSelector).click(function() {
      ...
      if(sUrl.length > 0) {
        ...
        tObj = wym._doc.createElement('img');
        tObj.src = sUrl;
        tObj.title = jQuery(wym._options.titleSelector).val();
        tObj.alt = jQuery(wym._options.altSelector).val();
        jQuery(wym._doc.body).append(tObj);
      }
      window.close();
  });
